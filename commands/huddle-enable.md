...
Sets `auto_trigger.enabled = true` in `${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/huddle}/config.json`.

## Steps

1. Run `node ${CLAUDE_PLUGIN_ROOT:-$HOME/.claude/skills/huddle}/lib/setup.js auto enable`.
